...
def draw_frame(N, epitrochoid, hypotrochoid):
    ...
    return [
                (1, 0, 1, epitrochoid_points),
                (0, 1, 1, hypotrochoid_points),
           ]
...
def makeImage(height, width, filename):
    ...
    hypo1 = shape.Hypotrochoid(30, 30, 100, 95, 90)
    hypo2 = shape.Hypotrochoid(300, 300, 100, 50, 200)
    ...
    for offset_num in range(offsets + 1):
        ...
        frame_points = draw_frame(N, hypo1.rotate(theta, 30, 30), 
                                     hypo2.offset(2 * theta))
